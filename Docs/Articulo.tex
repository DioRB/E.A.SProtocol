...
El cifrado César desplaza cada letra un número fijo de posiciones dentro del alfabeto. El cifrado Afín generaliza esta idea mediante una transformación afín sobre el conjunto de residuos módulo 26, definida por
\[
E(x)=(ax+b) \mod 26
\]
donde,
